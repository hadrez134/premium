...
public class Main13Activity extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlay = (Button) findViewById(R.id.buttonmanos);
        mYouTubePlayerView = (YouTubePlayerView) findViewById(R.id.manos2);
