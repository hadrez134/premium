...
public class Main34Activity extends YouTubeBaseActivity {

    private static final String TAG = "Main34Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlay = (Button) findViewById(R.id.buttonmanos2);
        mYouTubePlayerView = (YouTubePlayerView) findViewById(R.id.manos3);
